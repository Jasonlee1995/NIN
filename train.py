...
class NIN():
    def __init__(self, num_classes=10, gpu_id=0, print_freq=10, epoch_print=10, init_weights=True):
        ...
        self.model = model.NIN(num_classes=self.num_classes, init_weights=init_weights).cuda(self.gpu)
